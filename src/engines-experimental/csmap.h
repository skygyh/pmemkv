...
public:
	...
	public:
		...
		explicit bidirection_iterator(internal::csmap::pmem_type * _container, bool seek_end);
		~bidirection_iterator();
	...
	private:
		internal::csmap::pmem_type::iterator m_cur;
		internal::csmap::pmem_type::iterator m_beg;
		internal::csmap::pmem_type::iterator m_end;
	};	
