...
public:
	...
	public:
		...
		explicit bidirection_iterator(internal::csmap::map_t * _container, bool seek_end);
		~bidirection_iterator();
	...
	private:
		internal::csmap::map_t::iterator m_cur;
		internal::csmap::map_t::iterator m_beg;
		internal::csmap::map_t::iterator m_end;
	};	
